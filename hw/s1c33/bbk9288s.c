...
#define TYPE_BBK9288_MACHINE    MACHINE_TYPE_NAME("bbk9288")
...
#define BBK9288S_BOARD_USB_STATUS 0x22
#define BBK9288S_BOARD_USB_CONNECTED_BIT 0x80
...
#define BBK9288S_TOUCH_IO_SIZE  0x00001000u
...
#define BBK9288_AUDIO_IO_SIZE   0x00001000u
...
#define BBK9288S_AUDIO_PLAYER_BUFFER_SIZE 4096
#define BBK9288_EXPANSION_READY  0x0202
...
#define BBK9288S_NAND_DIRTY_BYTES DIV_ROUND_UP(BBK9288S_NAND_BLOCKS, 8)
#define BBK9288S_NAND_FLUSH_DELAY_MS 250
...
#define BBK9288_LCD_WIDTH       320
#define BBK9288_LCD_HEIGHT      240
#define BBK9288S_LCD_MAX_BPP    8
...
#define BBK9288S_16TM0A_VECTOR  31
#define BBK9288S_16TM0B_IRQ_BIT 0x04
#define BBK9288S_16TM0B_VECTOR  30
#define BBK9288S_16TM1A_IRQ_BIT 0x80
#define BBK9288S_16TM1A_VECTOR  35
#define BBK9288S_16TM1B_IRQ_BIT 0x40
#define BBK9288S_16TM1B_VECTOR  34
...
#define BBK9288S_8TM_DIRECT_CLOCK 0x0146
#define BBK9288S_8TM_CLOCK01    0x014d
#define BBK9288S_8TM_CLOCK23    0x014e
#define BBK9288S_8TM_CTRL_RUN   0x01
#define BBK9288S_8TM_CTRL_PRESET 0x02
...
#define BBK9288S_SIF0_STATUS    0x01e2
#define BBK9288S_SIF1_STATUS    0x01e7
#define BBK9288S_SIF2_STATUS    0x01f2
#define BBK9288S_SIF3_STATUS    0x01f7
#define BBK9288S_SIF_TDBE       0x02
...
#define BBK9288S_BACKLIGHT_GPIO_BIT 0x08
...
#define BBK9288_KEY_ROWS          8
#define BBK9288_KEY_COLS          7
#define BBK9288_KEY_MATRIX_IDS    (BBK9288_KEY_ROWS * \
                                   (BBK9288_KEY_COLS + 1))
#define BBK9288_KEY_ROW_SELECT    0x0f46
...
#define BBK9288S_LCDC_MODE0     0x0200
#define BBK9288S_LCDC_MODE1     0x0202
#define BBK9288S_LCDC_SADDR     0x0210
#define BBK9288S_LCDC_LUT_BASE  0x0400
#define BBK9288S_LCDC_LUT_END   0x0800
#define BBK9288S_LCDC_LUT_ENTRY_SIZE 4
#define BBK9288S_LCDC_LUT_GREEN 1
#define BBK9288S_LCDC_BPP_MASK  0x07
#define BBK9288S_LCDC_LUTPASS   0x10
...
typedef struct BBK9288SState {
    ...
    uint8_t audio_regs[BBK9288_AUDIO_IO_SIZE];
    uint8_t audio_seen[BBK9288_AUDIO_IO_SIZE];
    ...
    uint16_t keyboard_matrix_down_count[BBK9288_KEY_ROWS]
                                               [BBK9288_KEY_COLS];
    ...
    char *nand_image_path;
    FILE *nand_file;
    uint8_t nand_dirty_blocks[BBK9288S_NAND_DIRTY_BYTES];
    bool nand_dirty;
    ...
    int audio_player_fd;
    uint8_t audio_player_buffer[BBK9288S_AUDIO_PLAYER_BUFFER_SIZE];
    size_t audio_player_buffer_len;
    ...
    QEMUTimer *timer16_compare_timer[2][2];
    QEMUTimer *timer2b_compare_timer;
    QEMUTimer *timer4b_compare_timer;
    QEMUTimer *timer8_underflow_timer[BBK9288S_8TM_CHANNELS];
    QEMUTimer *clock_timer;
    QEMUTimer *audio_flush_timer;
    QEMUTimer *nand_flush_timer;
...
static const char *bbk9288s_model_name(const BBK9288SState *s)
{
    return s->is_9288 ? "BBK9288" : "BBK9288S";
}
...
static void bbk9288s_timer0a_compare_cb(void *opaque);
static void bbk9288s_timer0b_compare_cb(void *opaque);
static void bbk9288s_timer1a_compare_cb(void *opaque);
static void bbk9288s_timer1b_compare_cb(void *opaque);
...
static void bbk9288s_timer8_0_underflow_cb(void *opaque);
static void bbk9288s_timer8_1_underflow_cb(void *opaque);
static void bbk9288s_timer8_2_underflow_cb(void *opaque);
static void bbk9288s_timer8_3_underflow_cb(void *opaque);
...
static void bbk9288s_nand_flush_cb(void *opaque);
...
static const BBK9288SRegInfo bbk9288s_regs[] = {
    ...
    { BBK9288S_ADC_MODE, "ADCADV", "adc-touch", 0x01, 0x00,
      BBK9288S_REG_NONE },
    { BBK9288S_8TM_DIRECT_CLOCK, "T8_DIRECT_CLK", "timer-8bit",
      0x0f, 0x00, BBK9288S_REG_NONE },
    { BBK9288S_8TM_CLOCK01, "T8_CLK01", "timer-8bit",
      0xff, 0x00, BBK9288S_REG_NONE },
    { BBK9288S_8TM_CLOCK23, "T8_CLK23", "timer-8bit",
      0xff, 0x00, BBK9288S_REG_NONE },
    { BBK9288S_8TM_CTRL_BASE + 0 * BBK9288S_8TM_STRIDE, "T8_CTRL0",
      "timer-8bit", 0x07, 0x00, BBK9288S_REG_NONE },
    ...
    { BBK9288S_CLG_PROTECT, "CLG_PROTECT", "clock-generator", 0xff, 0x00,
      BBK9288S_REG_NONE },
    /*
     * Standard serial I/F status.  Transfers complete immediately in this
     * board model, so TDBE remains asserted while no receive/error flags are
     * pending.
     */
    { BBK9288S_SIF0_STATUS, "SIF0_STATUS", "serial", 0x3f,
      BBK9288S_SIF_TDBE, BBK9288S_REG_NONE },
    { BBK9288S_SIF1_STATUS, "SIF1_STATUS", "serial", 0x3f,
      BBK9288S_SIF_TDBE, BBK9288S_REG_NONE },
    { BBK9288S_SIF2_STATUS, "SIF2_STATUS", "serial", 0x3f,
      BBK9288S_SIF_TDBE, BBK9288S_REG_NONE },
    { BBK9288S_SIF3_STATUS, "SIF3_STATUS", "serial", 0x3f,
      BBK9288S_SIF_TDBE, BBK9288S_REG_NONE },
...
static const char *bbk9288s_lcdc_reg_name(hwaddr offset)
{
    ...
    case BBK9288S_LCDC_VSIZE:
        return "VSIZE";
    case BBK9288S_LCDC_MODE0:
        return "MODE0";
    case BBK9288S_LCDC_MODE1:
        return "MODE1";
    ...
    case BBK9288S_LCDC_SADDR + 1:
        return "SADDR1";
    default:
        if (offset >= BBK9288S_LCDC_LUT_BASE &&
            offset < BBK9288S_LCDC_LUT_END) {
            return "LUT";
        }
        return "unknown";
    }
                                ...
                                uint8_t *level, const char **name)
{
    ...
    if ((timer16_0_1_active & BBK9288S_16TM1B_IRQ_BIT) != 0) {
        *vector = BBK9288S_16TM1B_VECTOR;
        *level = bbk9288s_irq_level_or_one(
            (s->io_regs[BBK9288S_PIR2_16TM0_1] >> 4) & 0x07);
        *name = "16tm1-b";
        return true;
    }
    if ((timer16_0_1_active & BBK9288S_16TM1A_IRQ_BIT) != 0) {
        *vector = BBK9288S_16TM1A_VECTOR;
        *level = bbk9288s_irq_level_or_one(
            (s->io_regs[BBK9288S_PIR2_16TM0_1] >> 4) & 0x07);
        *name = "16tm1-a";
        return true;
    ...
    for (timer8 = 0; timer8 < BBK9288S_8TM_CHANNELS; timer8++) {
        ...
        *vector = BBK9288S_8TM0_VECTOR + timer8;
        *level = bbk9288s_irq_level_or_one(
...
static void bbk9288s_clock_timer_init_rtc(BBK9288SState *s)
{
    ...
    info_report("%s battery RTC initialized: "
                "%04u-%02u-%02u %02u:%02u:%02u day=%u",
                bbk9288s_model_name(s),
...
static bool bbk9288s_keyboard_any_down(BBK9288SState *s)
{
    ...
    if (s->is_9288) {
        for (row = 0; row < BBK9288_KEY_ROWS; row++) {
            for (col = 0; col < BBK9288_KEY_COLS; col++) {
                if (s->keyboard_matrix_down_count[row][col] != 0) {
                    return true;
                }
            }
        }
    ...
    for (row = 0; row < BBK9288S_KEY_LINES; row++) {
        if (s->keyboard_line_down_count[row] != 0) {
            return true;
        }
    }
    return false;
...
/*
 * V1.5 kernel table at 0x021994dc.  Each non-zero matrix position is
 * translated by the firmware to a Linux input key code before it enters the
 * GUI event queue.  Keeping the same table here lets QEMU invert that wiring
 * for normal host keyboard events.
 */
static const uint8_t bbk9288_matrix_to_linux[BBK9288_KEY_MATRIX_IDS] = {
    0x00, 0x0b, 0x10, 0x1e, 0x2c, 0x18, 0x3f, 0x01,
    0x00, 0x02, 0x11, 0x1f, 0x2d, 0x19, 0x3b, 0x1c,
    0x00, 0x03, 0x12, 0x20, 0x2e, 0x26, 0x40, 0x68,
    0x00, 0x04, 0x13, 0x21, 0x2f, 0x09, 0x78, 0x6d,
    0x00, 0x05, 0x14, 0x22, 0x30, 0x0a, 0x57, 0x00,
    0x00, 0x06, 0x15, 0x23, 0x31, 0x00, 0x6f, 0x00,
    0x00, 0x07, 0x16, 0x24, 0x32, 0x00, 0x39, 0x00,
    0x00, 0x08, 0x17, 0x25, 0x67, 0x6c, 0x69, 0x6a,
};

static unsigned bbk9288_keyboard_scan_code_for_qcode(int qcode)
{
    uint16_t linux_code;
    unsigned matrix_id;
    ...
    if (qcode < 0 || qcode >= qemu_input_map_qcode_to_linux_len) {
        return BBK9288_KEY_MATRIX_IDS;
    }

    /*
     * The firmware returns a one-based column in each eight-byte row, leaving
     * matrix IDs 0, 8, 16 ... unused.  Invert its board table so letters,
     * digits, function keys, page keys and all four arrows retain their host
     * meanings.
     */
    linux_code = qemu_input_map_qcode_to_linux[qcode];
    if (linux_code == 0 || linux_code > UINT8_MAX) {
        return BBK9288_KEY_MATRIX_IDS;
    }
    for (matrix_id = 1; matrix_id < ARRAY_SIZE(bbk9288_matrix_to_linux);
         matrix_id++) {
        if (bbk9288_matrix_to_linux[matrix_id] == linux_code) {
            return matrix_id;
        }
    }
...
static void bbk9288_keyboard_refresh_matrix(BBK9288SState *s)
{
    uint8_t row_select = s->touch_io_regs[BBK9288_KEY_ROW_SELECT];
    uint8_t k5_low = 0;
    uint8_t p0_low = 0;
    unsigned row;
    unsigned col;
    ...
    s->gpio_input_low[BBK9288S_KEY_GPIO_PORT] =
        (s->gpio_input_low[BBK9288S_KEY_GPIO_PORT] & ~0x70) | p0_low;
}
...
static void bbk9288s_keyboard_refresh_lines(BBK9288SState *s)
{
    ...
    if (s->is_9288) {
        bbk9288_keyboard_refresh_matrix(s);
                                    ...
                                    InputEvent *evt)
{
    ...
    if (s->is_9288) {
        scan_code = bbk9288_keyboard_scan_code_for_qcode(qcode);
        if (scan_code >= BBK9288_KEY_MATRIX_IDS) {
            return;
        }
        row = scan_code >> 3;
        col = (scan_code & 7) - 1;
        ...
        if (key->down) {
            ...
            key_changed = s->keyboard_matrix_down_count[row][col] == 0;
            s->keyboard_qcode_down[qcode] = true;
            s->keyboard_matrix_down_count[row][col]++;
            bbk9288s_keyboard_refresh_lines(s);
            qemu_log_mask(LOG_GUEST_ERROR,
                          "bbk9288-input: key down qcode=%d scan=%u "
                          "row=%u col=%u k5=0x%02x p0=0x%02x wake=%s\n",
                          qcode, scan_code, row, col, s->k5_input_low,
                          s->gpio_input_low[BBK9288S_KEY_GPIO_PORT],
                          key_changed ? "port-input" : "none");
        } else {
            if (!s->keyboard_qcode_down[qcode]) {
                return;
            }
            ...
            bbk9288s_keyboard_refresh_lines(s);
            qemu_log_mask(LOG_GUEST_ERROR,
                          "bbk9288-input: key up qcode=%d scan=%u "
                          "row=%u col=%u k5=0x%02x p0=0x%02x\n",
                          qcode, scan_code, row, col, s->k5_input_low,
                          s->gpio_input_low[BBK9288S_KEY_GPIO_PORT]);
        }
        return;
                                   ...
                                   InputEvent *evt)
{
    ...
    case INPUT_EVENT_KIND_ABS:
        ...
        if (move->axis == INPUT_AXIS_X) {
            ...
            s->adc_touch_x =
                bbk9288s_touch_pixel_to_adc(x, s->lcd_width - 1);
            s->touch_pixel_x = x;
                                             ...
                                             unsigned channel)
{
    ...
    clock_ctrl = s->io_regs[BBK9288S_16TM_CLOCK_CTRL(channel)];
    if ((ctrl & BBK9288S_16TM_CTRL_PRUN) == 0) {
        return false;
    }
    return (clock_ctrl & 0x08) != 0 &&
           (ctrl & BBK9288S_16TM_CTRL_CKSL) == 0;
}
...
static uint64_t bbk9288s_timer16_compare_period_ns(BBK9288SState *s,
                                                   unsigned channel,
                                                   bool compare_a)
{
    ...
    count = bbk9288s_timer16_lduw(s, BBK9288S_16TM_COUNTER(channel));
    compare = bbk9288s_timer16_lduw(
        s, compare_a ? BBK9288S_16TM_COMPARE_A(channel) :
                       BBK9288S_16TM_COMPARE_B(channel));
    ticks = compare > count ? compare - count :
                              0x10000u + compare - count;
    cycles = (uint64_t)ticks * divisors[clock_ctrl & 0x07];
    if ((s->io_regs[BBK9288S_PRESCALER_CLOCK_SELECT] &
         BBK9288S_PRESCALER_OSC1) != 0) {
        source_hz = BBK9288S_OSC1_HZ;
    }
    return MAX(DIV_ROUND_UP(cycles * NANOSECONDS_PER_SECOND, source_hz),
               1);
}

static void bbk9288s_timer16_schedule_channel(BBK9288SState *s,
                                               unsigned channel)
{
    static QEMUTimerCB * const callbacks[2][2] = {
        { bbk9288s_timer0a_compare_cb, bbk9288s_timer0b_compare_cb },
        { bbk9288s_timer1a_compare_cb, bbk9288s_timer1b_compare_cb },
    };
    int64_t now = qemu_clock_get_ns(QEMU_CLOCK_REALTIME);
    unsigned which;

    if (!bbk9288s_timer16_channel_running(s, channel)) {
        for (which = 0; which < 2; which++) {
            if (s->timer16_compare_timer[channel][which] != NULL) {
                timer_del(s->timer16_compare_timer[channel][which]);
            }
        }
        return;
    }
    for (which = 0; which < 2; which++) {
        if (s->timer16_compare_timer[channel][which] == NULL) {
            s->timer16_compare_timer[channel][which] =
                timer_new_ns(QEMU_CLOCK_REALTIME,
                             callbacks[channel][which], s);
        }
        timer_mod_ns(s->timer16_compare_timer[channel][which],
                     now + bbk9288s_timer16_compare_period_ns(
                               s, channel, which == 0));
    }
}

static void bbk9288s_timer16_compare_cb(BBK9288SState *s,
                                        unsigned channel, bool compare_a)
{
    uint16_t compare = bbk9288s_timer16_lduw(
        s, compare_a ? BBK9288S_16TM_COMPARE_A(channel) :
                       BBK9288S_16TM_COMPARE_B(channel));
    uint8_t irq_bit = channel == 0 ?
                      (compare_a ? BBK9288S_16TM0A_IRQ_BIT :
                                   BBK9288S_16TM0B_IRQ_BIT) :
                      (compare_a ? BBK9288S_16TM1A_IRQ_BIT :
                                   BBK9288S_16TM1B_IRQ_BIT);

    if (!bbk9288s_timer16_channel_running(s, channel)) {
        bbk9288s_timer16_update(s);
        return;
    }
    bbk9288s_timer16_stw(s, BBK9288S_16TM_COUNTER(channel),
                         compare_a ? compare : 0);
    bbk9288s_timer16_compare_match(s, channel,
                                   compare_a ? "a" : "b",
                                   irq_bit, compare);
    if (!compare_a) {
        bbk9288s_timer16_schedule_channel(s, channel);
    }
}

static void bbk9288s_timer0a_compare_cb(void *opaque)
{
    bbk9288s_timer16_compare_cb(opaque, 0, true);
}

static void bbk9288s_timer0b_compare_cb(void *opaque)
{
    bbk9288s_timer16_compare_cb(opaque, 0, false);
}

static void bbk9288s_timer1a_compare_cb(void *opaque)
{
    bbk9288s_timer16_compare_cb(opaque, 1, true);
}

static void bbk9288s_timer1b_compare_cb(void *opaque)
{
    bbk9288s_timer16_compare_cb(opaque, 1, false);
}
...
static bool bbk9288s_timer8_channel_running(BBK9288SState *s,
                                             unsigned channel)
{
    hwaddr ctrl = BBK9288S_8TM_CTRL_BASE +
                  channel * BBK9288S_8TM_STRIDE;
    hwaddr clock_reg = channel < 2 ? BBK9288S_8TM_CLOCK01 :
                                     BBK9288S_8TM_CLOCK23;
    unsigned shift = (channel & 1) * 4;

    return (s->io_regs[ctrl] & BBK9288S_8TM_CTRL_RUN) != 0 &&
           (s->io_regs[clock_reg] & (0x08u << shift)) != 0;
}
...
static uint64_t bbk9288s_timer8_period_ns(BBK9288SState *s,
                                          unsigned channel)
{
    static const uint16_t divisors[BBK9288S_8TM_CHANNELS][8] = {
    ...
    hwaddr clock_reg = channel < 2 ? BBK9288S_8TM_CLOCK01 :
                                     BBK9288S_8TM_CLOCK23;
    unsigned shift = (channel & 1) * 4;
    unsigned select = (s->io_regs[clock_reg] >> shift) & 7;
    hwaddr count_reg = BBK9288S_8TM_CTRL_BASE +
                       channel * BBK9288S_8TM_STRIDE + 2;
    uint64_t ticks = (uint64_t)s->io_regs[count_reg] + 1;
    uint64_t divisor = divisors[channel][select];
    uint64_t source_hz = BBK9288S_OSC3_PLL_HZ;

    if ((s->io_regs[BBK9288S_8TM_DIRECT_CLOCK] &
         (1u << channel)) != 0) {
        divisor = 1;
    }
    if ((s->io_regs[BBK9288S_PRESCALER_CLOCK_SELECT] &
    ...
    return MAX(DIV_ROUND_UP(ticks * divisor * NANOSECONDS_PER_SECOND,
                            source_hz), 1);
}

static void bbk9288s_timer8_update(BBK9288SState *s)
{
    static QEMUTimerCB * const callbacks[BBK9288S_8TM_CHANNELS] = {
        bbk9288s_timer8_0_underflow_cb,
        bbk9288s_timer8_1_underflow_cb,
        bbk9288s_timer8_2_underflow_cb,
        bbk9288s_timer8_3_underflow_cb,
    };
    int64_t now = qemu_clock_get_ns(QEMU_CLOCK_REALTIME);
    unsigned channel;

    for (channel = 0; channel < BBK9288S_8TM_CHANNELS; channel++) {
        QEMUTimer **timer = &s->timer8_underflow_timer[channel];
        ...
        if (*timer == NULL) {
            *timer = timer_new_ns(QEMU_CLOCK_REALTIME,
                                  callbacks[channel], s);
        }
        timer_mod_ns(*timer, now + bbk9288s_timer8_period_ns(s, channel));
    }
    if (s->trace_io) {
        qemu_log_mask(LOG_GUEST_ERROR,
                      "bbk9288s-timer: 8tm0-3 schedule running=0x%02x "
                      "fir=0x%02x\n",
...
static void bbk9288s_timer8_underflow(BBK9288SState *s, unsigned channel)
{
    hwaddr reload_reg = BBK9288S_8TM_CTRL_BASE +
    ...
    if (!bbk9288s_timer8_channel_running(s, channel)) {
        if (s->timer8_underflow_timer[channel] != NULL) {
            timer_del(s->timer8_underflow_timer[channel]);
        }
        return;
    }
    ...
    timer_mod_ns(s->timer8_underflow_timer[channel],
                 ...
                 bbk9288s_timer8_period_ns(s, channel));
}

static void bbk9288s_timer8_0_underflow_cb(void *opaque)
{
    bbk9288s_timer8_underflow(opaque, 0);
}

static void bbk9288s_timer8_1_underflow_cb(void *opaque)
{
    bbk9288s_timer8_underflow(opaque, 1);
}

static void bbk9288s_timer8_2_underflow_cb(void *opaque)
{
    bbk9288s_timer8_underflow(opaque, 2);
}

static void bbk9288s_timer8_3_underflow_cb(void *opaque)
{
    bbk9288s_timer8_underflow(opaque, 3);
}
...
static bool bbk9288s_backlight_on(BBK9288SState *s)
{
    uint8_t output = s->io_regs[BBK9288S_PORT2_IOCTRL];
    uint8_t latch = s->io_regs[BBK9288S_PORT2_DATA];

    /*
     * The panel backlight enable is active-low on P2.3. Until the firmware
     * configures that pin as an output, keep the panel visible.
     */
    return (output & BBK9288S_BACKLIGHT_GPIO_BIT) == 0 ||
           (latch & BBK9288S_BACKLIGHT_GPIO_BIT) == 0;
}
                                            ...
                                            unsigned port_index)
{
     ...
     */
    if (!s->is_9288 && port_index == BBK9288S_KEY_GPIO_PORT &&
...
static void bbk9288s_hsdma_store_address(BBK9288SState *s, hwaddr offset,
                                         uint16_t old_high, uint32_t addr)
{
    bbk9288s_io_stw_raw(s, offset, addr & 0xffff);
    bbk9288s_io_stw_raw(s, offset + 2,
                        (old_high & 0xf000) | ((addr >> 16) & 0x0fff));
}
...
static void bbk9288s_hsdma_run_channel(BBK9288SState *s, unsigned channel)
{
    ...
    uint32_t initial_src = src;
    uint32_t initial_dst = dst;
    uint32_t remaining;
    uint32_t units;
    uint8_t buf[2];
    ...
    if (mode == 3) {
        qemu_log_mask(LOG_GUEST_ERROR,
                      "bbk9288s-hsdma: ch%u reserved mode %u; "
                      "trigger cleared\n",
                      channel, mode);
        return;
    }
    ...
    if (mode == 2) {
        remaining = ((uint32_t)(ctrl & 0xff) << 8) |
                    (count_reg >> 8);
        ...
        remaining = ((uint32_t)(ctrl & 0xff) << 16) | count_reg;
        units = mode == 0 ? MIN(remaining, 1u) : remaining;
    }
    if (remaining == 0) {
    ...
    if (log_transfer) {
        qemu_log_mask(LOG_GUEST_ERROR,
                      "bbk9288s-hsdma: ch%u transfer=%" PRIu64 " %s "
                      "mode=%u units=%u remaining=%u unit=%u "
                      "src=0x%08x dst=0x%08x sctl=%u dctl=%u\n",
                      channel, s->hsdma_transfer_count[channel],
                      dual ? "dual" : "single", mode, units, remaining,
    ...
    for (i = 0; i < units; i++) {
        if (dual) {
            ...
            dst = bbk9288s_hsdma_next_address(
                dst, dst_control, unit_size);
        } else if ((ctrl & 0x4000) != 0) {
            /* External I/O input is modeled as an idle, pulled-up bus. */
            memset(buf, 0xff, unit_size);
            cpu_physical_memory_write(src, buf, unit_size);
            if (log_transfer) {
                bbk9288s_ivram_stats_add(&dst_ivram, src, buf, unit_size);
            }
        } else {
            /* Memory-to-external-I/O transfers consume and discard data. */
            cpu_physical_memory_read(src, buf, unit_size);
            if (log_transfer) {
                bbk9288s_ivram_stats_add(&src_ivram, src, buf, unit_size);
            }
    ...
    if (mode == 2 && src_control == 2) {
        src = initial_src;
    }
    if (mode == 2 && dst_control == 2) {
        dst = initial_dst;
    }
    bbk9288s_hsdma_store_address(s, base + 0x04, src_high, src);
    if (dual) {
        bbk9288s_hsdma_store_address(s, base + 0x08, dst_high, dst);
    }
    if (log_transfer) {
    ...
    if (mode == 2) {
        remaining--;
        count_reg = (remaining & 0xff) << 8 |
                    (count_reg & 0xff);
        ctrl = (ctrl & 0xff00) | ((remaining >> 8) & 0xff);
    } else {
        remaining -= units;
        count_reg = remaining & 0xffff;
        ctrl = (ctrl & 0xff00) | ((remaining >> 16) & 0xff);
    }
    bbk9288s_io_stw_raw(s, base + 0x00, count_reg);
    bbk9288s_io_stw_raw(s, base + 0x02, ctrl);
    if (remaining == 0) {
        bbk9288s_hsdma_finish_channel(s, channel, base, ctrl);
    }
}
...
static bool bbk9288s_timer8_write_byte(BBK9288SState *s, hwaddr offset,
                                       uint8_t value)
{
    unsigned channel;
    unsigned rel;
    ...
    if (offset < BBK9288S_8TM_CTRL_BASE ||
        offset >= BBK9288S_8TM_CTRL_BASE +
                  BBK9288S_8TM_CHANNELS * BBK9288S_8TM_STRIDE) {
        return false;
    }
    channel = (offset - BBK9288S_8TM_CTRL_BASE) /
              BBK9288S_8TM_STRIDE;
    rel = (offset - BBK9288S_8TM_CTRL_BASE) %
          BBK9288S_8TM_STRIDE;
    base = BBK9288S_8TM_CTRL_BASE +
           channel * BBK9288S_8TM_STRIDE;

    switch (rel) {
    case 0:
        if ((value & BBK9288S_8TM_CTRL_PRESET) != 0) {
            s->io_regs[base + 2] = s->io_regs[base + 1];
        }
        s->io_regs[base] = (value & 0x07) &
                           ~BBK9288S_8TM_CTRL_PRESET;
        break;
    case 1:
        s->io_regs[offset] = value;
        break;
    case 2:
        /* The down-counter is read-only. */
        return true;
    default:
        return false;
    }
                                   ...
                                   uint8_t value)
{
    ...
    if (offset == BBK9288S_SIF0_STATUS ||
        offset == BBK9288S_SIF1_STATUS ||
        offset == BBK9288S_SIF2_STATUS ||
        offset == BBK9288S_SIF3_STATUS) {
        /*
         * Error flags are write-zero-to-clear; TDBE and TEND are read-only.
         * With the instantaneous backend there is never a full TX buffer.
         */
        s->io_regs[offset] = BBK9288S_SIF_TDBE;
        return;
    }
    ...
    if (bbk9288s_timer8_write_byte(s, offset, value)) {
        return;
    }
...
{
    bool backlight_was_on = bbk9288s_backlight_on(s);
    unsigned i;
    ...
    if ((bbk9288s_range_touches(offset, size, BBK9288S_PORT2_DATA, 1) ||
         bbk9288s_range_touches(offset, size, BBK9288S_PORT2_IOCTRL, 1)) &&
        backlight_was_on != bbk9288s_backlight_on(s)) {
        if (s->trace_io) {
            qemu_log_mask(LOG_GUEST_ERROR,
                          "bbk9288s-lcd: backlight %s "
                          "p2d=0x%02x ioc2=0x%02x\n",
                          bbk9288s_backlight_on(s) ? "on" : "off",
                          s->io_regs[BBK9288S_PORT2_DATA],
                          s->io_regs[BBK9288S_PORT2_IOCTRL]);
        }
    ...
    if (bbk9288s_range_touches(offset, size, BBK9288S_PIR_8TM_SIF0, 1) ||
        ...
        bbk9288s_range_touches(offset, size,
                               BBK9288S_8TM_DIRECT_CLOCK, 1) ||
        bbk9288s_range_touches(offset, size, BBK9288S_8TM_CLOCK01, 2) ||
        bbk9288s_range_touches(offset, size,
                               BBK9288S_PRESCALER_CLOCK_SELECT, 1) ||
...
static void bbk9288s_io_reset(BBK9288SState *s)
{
    ...
    memset(s->keyboard_matrix_down_count, 0,
           sizeof(s->keyboard_matrix_down_count));
    s->adc_touch_x = 512;
    s->adc_touch_y = 512;
    s->touch_pixel_x = s->lcd_width / 2;
    s->touch_pixel_y = s->lcd_height / 2;
    ...
    for (i = 0; i < 2; i++) {
        ...
        for (which = 0; which < 2; which++) {
            if (s->timer16_compare_timer[i][which] != NULL) {
                timer_del(s->timer16_compare_timer[i][which]);
            }
        }
    }
    for (i = 0; i < BBK9288S_8TM_CHANNELS; i++) {
        if (s->timer8_underflow_timer[i] != NULL) {
            timer_del(s->timer8_underflow_timer[i]);
        }
    }
    if (s->timer2b_compare_timer != NULL) {
        timer_del(s->timer2b_compare_timer);
...
static void bbk9288s_board_io_reset(BBK9288SState *s)
{
    ...
    if (s->usb_connected) {
        s->board_regs[BBK9288S_BOARD_USB_STATUS] =
            BBK9288S_BOARD_USB_CONNECTED_BIT;
    }
...
static void bbk9288s_exit_notify(Notifier *notifier, void *data)
{
    ...
    if (s->nand_flush_timer != NULL) {
        timer_del(s->nand_flush_timer);
    }
    ...
    bbk9288s_audio_flush_cb(s);
    if (s->audio_player_fd >= 0) {
        close(s->audio_player_fd);
        s->audio_player_fd = -1;
    }
    if (s->audio_player_pid != 0) {
        g_spawn_close_pid(s->audio_player_pid);
        s->audio_player_pid = 0;
    }
    g_free(s->audio_stream_path);
    s->audio_stream_path = NULL;
    g_free(s->audio_player_path);
    s->audio_player_path = NULL;
...
static void bbk9288s_audio_detect_rate(BBK9288SState *s, uint8_t value)
{
    ...
    s->audio_decode_remainder = 0;
    info_report("%s audio MPEG rate: %u kbps", bbk9288s_model_name(s),
...
static void bbk9288s_audio_flush_cb(void *opaque)
{
    ...
    if (s->audio_player_fd >= 0 && s->audio_player_buffer_len != 0) {
        written = qemu_write_full(s->audio_player_fd,
                                  s->audio_player_buffer,
                                  s->audio_player_buffer_len);
        if (written != s->audio_player_buffer_len) {
            warn_report("%s audio player stopped accepting data: %s",
                        bbk9288s_model_name(s), strerror(errno));
            close(s->audio_player_fd);
            s->audio_player_fd = -1;
        }
        s->audio_player_buffer_len = 0;
    }
}
...
static bool bbk9288s_audio_stream_rotate(BBK9288SState *s)
{
    ...
    s->audio_flush_bytes = 0;
    if (s->audio_stream == NULL) {
        warn_report("could not rotate %s audio stream '%s': %s",
                    bbk9288s_model_name(s), s->audio_stream_path,
                    strerror(errno));
        return false;
    }
    info_report("%s audio stream rotated at %u MiB",
                bbk9288s_model_name(s),
...
static void bbk9288s_audio_stream_write(BBK9288SState *s, uint8_t value)
{
    ...
    if (s->audio_stream != NULL && bbk9288s_audio_stream_rotate(s)) {
        if (fputc(value, s->audio_stream) == EOF) {
            warn_report("%s audio stream write failed: %s",
                        bbk9288s_model_name(s), strerror(errno));
            fclose(s->audio_stream);
            s->audio_stream = NULL;
        } else {
    ...
    if (s->audio_player_fd >= 0) {
        s->audio_player_buffer[s->audio_player_buffer_len++] = value;
        queued = true;
    }

    if (!queued || s->audio_flush_timer == NULL) {
        return;
    }
    if (s->audio_flush_bytes >= BBK9288S_AUDIO_STREAM_FLUSH_BYTES ||
        s->audio_player_buffer_len == sizeof(s->audio_player_buffer)) {
        bbk9288s_audio_flush_cb(s);
        timer_del(s->audio_flush_timer);
    } else {
                                      ...
                                      unsigned size)
{
    ...
    if (offset + size > s->audio_io_size) {
        return 0;
    }
                                   ...
                                   uint64_t value, unsigned size)
{
    ...
    if (s->is_9288 && offset == BBK9288_EXPANSION_READY &&
        size >= 2 && (value & 0xffff) == 4) {
        /*
         * The 9288 programs the external board controller at 0x003a0200,
         * then writes command 4 here and polls until the controller reports
         * ready as value 8.  This window is absent from the 9288S firmware.
         */
        s->audio_regs[BBK9288_EXPANSION_READY] = 8;
        s->audio_regs[BBK9288_EXPANSION_READY + 1] = 0;
    }
                                ...
                                const char *player_path)
{
    ...
    s->audio_player_path =
        g_strdup(player_path != NULL && player_path[0] != 0 ?
                 player_path : NULL);
    s->audio_player_fd = -1;
    s->audio_stream_bytes = 0;
    s->audio_flush_bytes = 0;
    ...
    if (s->audio_stream_path == NULL && s->audio_player_path == NULL) {
        info_report("%s audio stream output disabled",
                    bbk9288s_model_name(s));
        return;
    }
    if (s->audio_stream_path != NULL) {
        s->audio_stream = fopen(s->audio_stream_path, "wb");
        if (s->audio_stream == NULL) {
            warn_report("could not open %s audio stream '%s': %s",
                        bbk9288s_model_name(s), s->audio_stream_path,
                        strerror(errno));
        } else {
            info_report("%s audio stream: %s", bbk9288s_model_name(s),
                        s->audio_stream_path);
        }
    }
    if (s->audio_player_path != NULL &&
        !g_spawn_async_with_pipes(
            NULL, (char **)argv, NULL,
            G_SPAWN_CLOEXEC_PIPES | G_SPAWN_DO_NOT_REAP_CHILD |
            G_SPAWN_STDOUT_TO_DEV_NULL | G_SPAWN_STDERR_TO_DEV_NULL,
            NULL, NULL, &s->audio_player_pid, &s->audio_player_fd,
            NULL, NULL, &gerr)) {
        warn_report("could not start %s audio player '%s': %s",
                    bbk9288s_model_name(s), s->audio_player_path,
                    gerr->message);
        s->audio_player_pid = 0;
        s->audio_player_fd = -1;
    } else if (s->audio_player_path != NULL) {
        info_report("%s audio player: %s", bbk9288s_model_name(s),
                    s->audio_player_path);
    }
    if (s->audio_stream != NULL || s->audio_player_fd >= 0) {
        s->audio_flush_timer =
...
static void bbk9288s_nand_storage_init(BBK9288SState *s, const char *path)
{
    ...
    memset(s->nand_dirty_blocks, 0, sizeof(s->nand_dirty_blocks));
    s->nand_image_path = g_strdup(path != NULL && path[0] != 0 ? path : NULL);

    if (s->nand_image_path == NULL) {
        info_report("%s NAND: volatile blank 256 MiB device",
                    bbk9288s_model_name(s));
        return;
    }
    exists = g_file_test(s->nand_image_path, G_FILE_TEST_EXISTS);
    if (!exists) {
        info_report("%s NAND: new blank image %s (%zu raw bytes)",
                    bbk9288s_model_name(s), s->nand_image_path,
                    s->nand_storage_size);
    } else if (!g_file_get_contents(s->nand_image_path, &contents, &length,
                                    &gerr)) {
        error_report("could not load %s NAND image '%s': %s",
                     bbk9288s_model_name(s), s->nand_image_path,
                     gerr->message);
        g_error_free(gerr);
        exit(1);
    }
    if (exists && length != s->nand_storage_size) {
        error_report("%s NAND image '%s' has %zu bytes; expected %zu",
                     bbk9288s_model_name(s), s->nand_image_path, (size_t)length,
                     s->nand_storage_size);
        g_free(contents);
        exit(1);
    }
    ...
    if (exists) {
        ...
        g_free(contents);
        info_report("%s NAND: loaded %s (%zu raw bytes)",
                    bbk9288s_model_name(s), s->nand_image_path,
                    s->nand_storage_size);
    }

    s->nand_file = fopen(s->nand_image_path, exists ? "r+b" : "w+b");
    if (s->nand_file == NULL) {
        error_report("could not open %s NAND image '%s' for persistence: %s",
                     bbk9288s_model_name(s), s->nand_image_path,
                     strerror(errno));
        exit(1);
    }
    if (!exists &&
        fwrite(s->nand_storage, 1, s->nand_storage_size, s->nand_file) !=
        s->nand_storage_size) {
        error_report("could not initialize %s NAND image '%s': %s",
                     bbk9288s_model_name(s), s->nand_image_path,
                     strerror(errno));
        exit(1);
    }
    fflush(s->nand_file);
    if (!exists) {
        qemu_fdatasync(fileno(s->nand_file));
    }
    s->nand_flush_timer =
        timer_new_ms(QEMU_CLOCK_REALTIME, bbk9288s_nand_flush_cb, s);
}
...
static void bbk9288s_nand_storage_save(BBK9288SState *s)
{
    ...
    if (!s->nand_dirty || s->nand_file == NULL) {
        return;
    }

    for (block = 0; block < BBK9288S_NAND_BLOCKS; block++) {
        unsigned byte = block / 8;
        uint8_t bit = 1u << (block % 8);
        size_t offset;

        if ((s->nand_dirty_blocks[byte] & bit) == 0) {
            continue;
        }
        offset = (size_t)block * BBK9288S_NAND_RAW_BLOCK_SIZE;
        if (fseek(s->nand_file, offset, SEEK_SET) != 0 ||
            fwrite(s->nand_storage + offset, 1,
                   BBK9288S_NAND_RAW_BLOCK_SIZE, s->nand_file) !=
            BBK9288S_NAND_RAW_BLOCK_SIZE) {
            error_report("could not incrementally save %s NAND block %u "
                         "to '%s': %s",
                         bbk9288s_model_name(s), block,
                         s->nand_image_path, strerror(errno));
            failed = true;
            break;
        }
        s->nand_dirty_blocks[byte] &= ~bit;
        flushed++;
    }

    if (flushed != 0) {
        fflush(s->nand_file);
        if (qemu_fdatasync(fileno(s->nand_file)) != 0) {
            error_report("could not synchronize %s NAND image '%s': %s",
                         bbk9288s_model_name(s), s->nand_image_path,
                         strerror(errno));
            failed = true;
        }
    ...
    if (flushed != 0 && (s->trace_io || failed)) {
        info_report("%s NAND: incrementally saved %u raw block%s to %s",
                    bbk9288s_model_name(s), flushed,
                    flushed == 1 ? "" : "s", s->nand_image_path);
    }
}

static void bbk9288s_nand_flush_cb(void *opaque)
{
    bbk9288s_nand_storage_save(opaque);
}

static void bbk9288s_nand_mark_dirty(BBK9288SState *s, unsigned block)
{
    if (block >= BBK9288S_NAND_BLOCKS) {
        return;
    }
    s->nand_dirty_blocks[block / 8] |= 1u << (block % 8);
    s->nand_dirty = true;
    if (s->nand_flush_timer != NULL) {
        timer_mod(s->nand_flush_timer,
                  qemu_clock_get_ms(QEMU_CLOCK_REALTIME) +
                  BBK9288S_NAND_FLUSH_DELAY_MS);
    }
}
                                             ...
                                             uint64_t ram_size)
{
    ...
    *length = size;
    info_report("%s boot: loaded kernel.bin from NAND FAT16 "
                "(cluster=%u size=%u)", bbk9288s_model_name(s),
                cluster, size);
    return data;
}
...
static void bbk9288s_nand_commit_page_cache(BBK9288SState *s)
{
    ...
    if (changed) {
        bbk9288s_nand_mark_dirty(
            s, s->nand_page / BBK9288S_NAND_PAGES_PER_BLOCK);
    }
}
...
static void bbk9288s_nand_erase_block(BBK9288SState *s)
{
    ...
    bbk9288s_nand_mark_dirty(
        s, first_page / BBK9288S_NAND_PAGES_PER_BLOCK);
    s->nand_erase_count++;
...
{
    switch (offset) {
    case BBK9288S_BOARD_USB_STATUS:
...
static unsigned bbk9288s_lcd_bpp(BBK9288SState *s)
{
    static const uint8_t bpp_by_mode[] = { 1, 2, 4, 8 };
    uint8_t mode = s->lcdc_regs[BBK9288S_LCDC_MODE0] &
                   BBK9288S_LCDC_BPP_MASK;

    if (mode < ARRAY_SIZE(bpp_by_mode)) {
        return bpp_by_mode[mode];
    }

    if (!(s->lcdc_seen[BBK9288S_LCDC_MODE0] & 4)) {
        s->lcdc_seen[BBK9288S_LCDC_MODE0] |= 4;
        qemu_log_mask(LOG_UNIMP,
                      "bbk9288s-lcd: unsupported BPP mode %u; "
                      "falling back to 2bpp\n", mode);
    }
    return 2;
}

static unsigned bbk9288s_lcd_stride(BBK9288SState *s, unsigned bpp)
{
    return s->lcd_width * bpp / 8;
}

static uint8_t bbk9288s_lcd_expand_six_bit(uint8_t value)
{
    value >>= 2;
    return (value << 2) | (value >> 4);
}

static uint8_t bbk9288s_lcd_gray_value(BBK9288SState *s, uint8_t pixel,
                                       unsigned bpp)
{
    uint8_t mode0 = s->lcdc_regs[BBK9288S_LCDC_MODE0];
    unsigned lut_offset;

    if (mode0 & BBK9288S_LCDC_LUTPASS) {
        if (bpp <= 4) {
            return pixel * 255 / ((1u << bpp) - 1);
        }
        return bbk9288s_lcd_expand_six_bit(pixel);
    }

    lut_offset = BBK9288S_LCDC_LUT_BASE +
                 pixel * BBK9288S_LCDC_LUT_ENTRY_SIZE +
                 BBK9288S_LCDC_LUT_GREEN;
    return bbk9288s_lcd_expand_six_bit(s->lcdc_regs[lut_offset]);
}

static uint8_t bbk9288s_lcd_unlit_value(uint8_t level)
{
    return 0x20 + ((uint16_t)level * (0x98 - 0x20) + 127) / 255;
}

static uint8_t bbk9288s_lcd_vram_pixel(BBK9288SState *s, unsigned x,
                                       unsigned y, unsigned bpp)
{
    unsigned stride = bbk9288s_lcd_stride(s, bpp);
    const uint8_t *src = s->ivram_ptr + y * stride;
    unsigned bit_offset = (x * bpp) & 7;
    unsigned shift = 8 - bpp - bit_offset;
    uint8_t mask = (1u << bpp) - 1;

    return (src[x * bpp / 8] >> shift) & mask;
}

static uint32_t bbk9288s_lcd_pixel(DisplaySurface *surface, uint8_t level)
{
...
static void bbk9288s_lcd_update(void *opaque)
{
    ...
    uint32_t colors[1 << BBK9288S_LCD_MAX_BPP];
    unsigned bpp;
    ...
    bpp = bbk9288s_lcd_bpp(s);
    color_count = 1u << bpp;
    backlight_on = bbk9288s_backlight_on(s);
    for (x = 0; x < color_count; x++) {
        uint8_t level = bbk9288s_lcd_gray_value(s, x, bpp);

        if (!backlight_on) {
            level = bbk9288s_lcd_unlit_value(level);
        }
        colors[x] = bbk9288s_lcd_pixel(surface, level);
    }

    for (y = 0; y < s->lcd_height; y++) {
        for (x = 0; x < s->lcd_width; x++) {
            uint8_t pixel = bbk9288s_lcd_vram_pixel(s, x, y, bpp);

            bbk9288s_lcd_store_pixel(surface, x, y, colors[pixel]);
        }
    }

    dpy_gfx_update(s->con, 0, 0, s->lcd_width, s->lcd_height);
}
...
static bool bbk9288s_lcd_dump_pgm(BBK9288SState *s, const char *path)
{
    ...
    GByteArray *out;
    GError *gerr = NULL;
    uint32_t counts[1 << BBK9288S_LCD_MAX_BPP] = { 0 };
    unsigned bpp;
    unsigned color_count;
    unsigned used = 0;
    bool ok;
    ...
    for (y = 0; y < s->lcd_height; y++) {
        for (x = 0; x < s->lcd_width; x++) {
            uint8_t pixel = bbk9288s_lcd_vram_pixel(s, x, y, bpp);
            uint8_t gray = bbk9288s_lcd_gray_value(s, pixel, bpp);
    ...
    qemu_log_mask(LOG_GUEST_ERROR,
                  "bbk9288s-lcd: dumped %ux%u %ubpp framebuffer to %s "
                  "gray-levels-used=%u/%u\n",
                  s->lcd_width, s->lcd_height, bpp, path,
                  used, color_count);
    return true;
}
...
{
    static const uint8_t default_green_lut[4] = {
        0x00, 0x54, 0xa8, 0xfc,
    };
    uint16_t hsize = s->lcd_width / 8 - 1;
    uint16_t vsize = s->lcd_height - 1;
    unsigned i;
     ...
     * standard four-level grayscale LUT while guest writes can still override
     * every LCDC register and switch to 4bpp/16-gray mode.
     */
    s->lcdc_regs[BBK9288S_LCDC_MODE0] = 1;
    ...
    for (i = 0; i < ARRAY_SIZE(default_green_lut); i++) {
        s->lcdc_regs[BBK9288S_LCDC_LUT_BASE +
                     i * BBK9288S_LCDC_LUT_ENTRY_SIZE +
                     BBK9288S_LCDC_LUT_GREEN] = default_green_lut[i];
    }
}
...
static void bbk9288s_load_kernel_data(BBK9288SState *s, S1C33CPU *cpu,
                                      const uint8_t *data,
                                      gsize len,
                                      const char *source,
                                      uint64_t ram_size)
{
    ...
    info_report("%s KNL %.16s: body=0x%x load=0x%08x pc=0x%08x",
                bbk9288s_model_name(s), data + 4, body_size,
                BBK9288S_SDRAM_BASE, pc);
}

static void bbk9288s_load_kernel_file(BBK9288SState *s, S1C33CPU *cpu,
                                      const char *filename,
                                      uint64_t ram_size)
{
    ...
    bbk9288s_load_kernel_data(s, cpu, (const uint8_t *)data, len,
                              filename, ram_size);
}
...
static void bbk9288s_init(MachineState *machine)
{
    ...
    s->audio_io_size =
        bms->is_9288 ? BBK9288_AUDIO_IO_SIZE : BBK9288S_AUDIO_IO_SIZE;
    s->has_touchscreen = !bms->is_9288;
    s->trace_io = bms->trace_io;
    s->trace_key_scan = bms->trace_key_scan;
    s->strict_board_io = bms->strict_board_io;
    s->usb_connected = bms->usb_connected;
    ...
    memory_region_init_io(&s->audio_io, NULL, &bbk9288s_audio_io_ops, s,
                          "bbk9288s.audio-decoder", s->audio_io_size);
    ...
    qemu_console_resize(s->con, s->lcd_width, s->lcd_height);
    ...
    if (kernel) {
        ...
        if (nand_kernel == NULL) {
            error_report("BBK 9288-family NAND does not contain a readable "
                         "FAT16 kernel.bin");
            exit(1);
        }
        bbk9288s_load_kernel_data(s, cpu, nand_kernel, nand_kernel_len,
    ...
    if (bms->debug_usb_wakeup_ms != 0) {
        ...
        info_report("%s debug USB wakeup scheduled after %u ms",
                    bbk9288s_model_name(s), bms->debug_usb_wakeup_ms);
    }
    if (bms->debug_nmi_wakeup_ms != 0) {
        ...
        info_report("%s debug NMI wakeup scheduled after %u ms",
                    bbk9288s_model_name(s), bms->debug_nmi_wakeup_ms);
    }
    if (bms->debug_port4_wakeup_ms != 0) {
        ...
        info_report("%s debug port4 wakeup scheduled after %u ms",
                    bbk9288s_model_name(s), bms->debug_port4_wakeup_ms);
    }
    if (bms->debug_port5_wakeup_ms != 0) {
        ...
        info_report("%s debug port5 wakeup scheduled after %u ms",
                    bbk9288s_model_name(s), bms->debug_port5_wakeup_ms);
    }
    if (bms->debug_lcd_dump_ms != 0) {
        ...
        info_report("%s debug LCD dump scheduled after %u ms to %s",
                    bbk9288s_model_name(s), bms->debug_lcd_dump_ms,
                    s->debug_lcd_dump_path);
    }
}
...
static char *bbk9288s_get_audio_player_path(Object *obj, Error **errp)
{
    const char *path = BBK9288S_MACHINE(obj)->audio_player_path;

    return g_strdup(path != NULL ? path : "");
}

static void bbk9288s_set_audio_player_path(Object *obj, const char *value,
                                           Error **errp)
{
    BBK9288SMachineState *bms = BBK9288S_MACHINE(obj);

    g_free(bms->audio_player_path);
    bms->audio_player_path =
        g_strdup(value != NULL && value[0] != 0 ? value : NULL);
}
...
static bool bbk9288s_get_usb_connected(Object *obj, Error **errp)
{
    return BBK9288S_MACHINE(obj)->usb_connected;
}

static void bbk9288s_set_usb_connected(Object *obj, bool value, Error **errp)
{
    BBK9288S_MACHINE(obj)->usb_connected = value;
}
...
static void bbk9288s_machine_instance_init(Object *obj)
{
    ...
    object_property_add_bool(obj, "usb-connected",
                             bbk9288s_get_usb_connected,
                             bbk9288s_set_usb_connected);
    object_property_set_description(obj, "usb-connected",
                                    "Expose USB VBUS on board status "
                                    "register 0x01000022 bit 7");
    ...
    object_property_set_description(obj, "audio-stream",
                                    ...
                                    "path");
    object_property_add_str(obj, "audio-player",
                            bbk9288s_get_audio_player_path,
                            bbk9288s_set_audio_player_path);
    object_property_set_description(obj, "audio-player",
                                    "Launch this ffplay-compatible program "
                                    "and stream decoded-board audio to it");
...
static void bbk9288_machine_instance_init(Object *obj)
{
    BBK9288SMachineState *bms = BBK9288S_MACHINE(obj);

    bms->is_9288 = true;
    g_free(bms->debug_lcd_dump_path);
    bms->debug_lcd_dump_path = g_strdup("bbk9288-lcd.pgm");
}

static void bbk9288_machine_class_init(ObjectClass *oc, const void *data)
{
    MachineClass *mc = MACHINE_CLASS(oc);

    mc->desc = "BBK 9288 (Epson S1C33L05, research)";
    mc->default_ram_id = "bbk9288.sdram";
}
...
static const TypeInfo bbk9288_machine_type_info = {
    .name = TYPE_BBK9288_MACHINE,
    .parent = TYPE_BBK9288S_MACHINE,
    .instance_init = bbk9288_machine_instance_init,
    .class_init = bbk9288_machine_class_init,
};

static void bbk9288s_machine_register_types(void)
{
    type_register_static(&bbk9288s_machine_type_info);
    type_register_static(&bbk9288_machine_type_info);
}
